...
import Web3D from "./mobile/AR/web3D/index.jsx";
import WebAR from "./mobile/AR/webAR/index.jsx";
            ...
            <MediaQuery query='(max-device-width: 992px)'>
                <Router>
                    <Switch>
                        ...
                        <Route component={Web3D} path='/productAR/web3D' exact/>
                        <Route component={WebAR} path='/productAR/webAR' exact/>
