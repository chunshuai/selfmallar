...
class Product extends React.Component {
    ...
    web3Dshow = () => {
        console.log("进入这里i");
        this.context.router.history.push({ pathname: '/productAR/web3D' });
    }
    webARshow = () => {
        this.context.router.history.push({ pathname: '/productAR/webAR' });
    }
    render() {
        ...
        const images = primaryImages && primaryImages.map((img, index) => {
            return <img src={"http://" + getServerIp() + img.mediumPath}
                key={index} style={{ margin: '0 auto', height: '14rem', width: '100%' }}
                alt="" onLoad={() => {
        ...
        return <Layout>
            ...
            <Card className="general_container">
                ...
                <div>
                    <Card>
                        <Flex justify="center">
                            {/* <Flex.Item align='center'><Link to={{pathname: '/productAR/web3D'}}> 3D展示</Link></Flex.Item> */}
                            <Flex.Item><Button onClick={this.web3Dshow}> 3D展示</Button></Flex.Item>
                            <Flex.Item><Button onClick={this.webARshow}>AR展示</Button></Flex.Item>
                            {/* <Flex.Item align='center'><Link to={{pathname: '/productAR/web3D'}}> 3D展示</Link></Flex.Item> 
                            <Flex.Item align='center'><Link to={{pathname: '/productAR/webAR'}}> AR展示</Link></Flex.Item>  */}
                        </Flex>
                    </Card>
                </div>
                <WingBlank>
                        ...
                        <WingBlank>
                            <div className="product_info_div">
                                ...
                                <Flex>
                                    ...
                                    <Flex.Item
                                        className="detail_val">{proData.specialty.durabilityPeriod}天</Flex.Item>
                                </Flex>
