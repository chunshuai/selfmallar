                        ...
                        for (let i = 0; i < this.state.files2.length; i++) {
                            ...
                            if(this.state.files2[i].id){
                                ...
                                if (sendPic === shouldUploadNum){
                                    for (var ii=0;ii<this.state.specificationList.length;ii++){
                                        this.state.specificationList[ii].parent = 0
                                        this.state.specificationList[ii].saleNumber = 1
                                        this.state.specificationList[ii].deliverPrice = 0
                                    }
                                    const param = {
                                        specialty: {
                                            name: this.state.name,
                                ...
                                upload.uploadImg(formData2, (rs)=>{
                                    ...
                                    if (rs && rs.success) {
                                        ...
                                        var tttemp = {mediumPath:rs.obj[0].mediumPath}
                                        imageList.push(tttemp);
                                        sendPic = sendPic + 1;
